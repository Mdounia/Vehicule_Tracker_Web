...
<title>Detail d'un GPS tracker</title>
</head>
<body>
	...
	<form action="GPSTracker">
		<div class="mb-3">
			<label for="id" class="form-label">Id</label> <input type="text"
				name="id" value="${gpsTracker.id}" readonly="readonly"
				class="form-control">
		</div>
		<div class="mb-3">
			<label for="simNumber" class="form-label">SIM Number</label> <input
				type="text" name="simNumber" value="${gpsTracker.simNumber}"
				class="form-control">
		</div>
		<div class="mb-3">
			<label for="imei" class="form-label">IMEI</label> <input
				type="text" name="imei" value="${gpsTracker.imei}"
				class="form-control">
		</div>
